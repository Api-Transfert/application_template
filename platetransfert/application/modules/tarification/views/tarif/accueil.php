        ...
        <div class='col-xs-12'>
            <div class="page-title">
                ...
                <div class="pull-left">
					...
					<h1 class="title">Grilles tarifaires</h1>
							...
							<td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a class="strc_view" data-id="<?=$tarif->tarifId?>" href="##"><i class="fa fa-eye"></i> Voir</a></li>
                                        <li><a class="strc_edit" data-id="<?=$tarif->tarifId?>" href="##"><i class="fa fa-edit"></i> Modifier</a></li>
                                        <li><a class="strc_delete" data-id="<?=$tarif->tarifId?>" href="##"><i class="fa fa-trash"></i> Supprimer</a></li>
                                        <li class="divider"></li>
