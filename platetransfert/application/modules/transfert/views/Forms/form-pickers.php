...
<link type="text/css" href="<?=bs('public/assets/plugins/form-daterangepicker/daterangepicker-bs3.css')?>" rel="stylesheet">    <!-- DateRangePicker -->
<link type="text/css" href="<?=bs('public/assets/plugins/iCheck/skins/minimal/blue.css')?>" rel="stylesheet">                   <!-- Custom Checkboxes / iCheck -->
<link type="text/css" href="<?=bs('public/assets/plugins/clockface/css/clockface.css')?>" rel="stylesheet">                   	<!-- Clockface -->
...
<script type="text/javascript" src="<?=bs('public/assets/plugins/form-daterangepicker/moment.min.js') ?>"></script>              			<!-- Moment.js for Date Range Picker -->
...
<script type="text/javascript" src="<?=bs('public/assets/plugins/form-daterangepicker/daterangepicker.js') ?>"></script>     				<!-- Date Range Picker -->
<script type="text/javascript" src="<?=bs('public/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.js') ?>"></script>      			<!-- Datepicker -->
<script type="text/javascript" src="<?=bs('public/assets/plugins/bootstrap-timepicker/bootstrap-timepicker.js') ?>"></script>      			<!-- Timepicker -->
<script type="text/javascript" src="<?=bs('public/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js') ?>"></script> <!-- DateTime Picker -->

<script type="text/javascript" src="<?=bs('public/assets/plugins/clockface/js/clockface.js') ?>"></script>     								<!-- Clockface -->


<script type="text/javascript" src="<?=bs('public/assets/demo/demo-pickers.js') ?>"></script>
