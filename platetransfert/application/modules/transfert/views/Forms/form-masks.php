...
<script type="text/javascript" src="<?=bs('public/assets/plugins/form-inputmask/jquery.inputmask.bundle.min.js') ?>"></script>     <!-- Input Masks Plugin -->

<script type="text/javascript" src="<?=bs('public/assets/demo/demo-mask.js') ?>"></script>
