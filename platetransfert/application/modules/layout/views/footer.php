...
<script>
    ...
    <script src="<?=bs()?>assets/plugins/select2/select2.min.js"></script>
    <script>
    ...
    <!--MESSENGER-->
<script src="<?=bs()?>assets/plugins/messenger/js/messenger.min.js"></script>
<script src="<?=bs()?>assets/plugins/messenger/js/messenger-theme-future.js"></script>
    <script src="<?=bs()?>assets/js/messenger.js"></script>
    ...
    <script src="<?=bs()?>assets/libs/tooltip/popper.min.js"></script>
    <script src="<?=bs()?>assets/libs/tooltip/custom.min.js"></script>
    <script src="<?=bs()?>assets/libs/custom/dp.min.js"></script>
    <script src="<?=bs()?>assets/libs/js/is_mobile.js"></script>
    <script src="<?=bs()?>assets/libs/sweetalert2/dist/sweetalert2.all.js"></script>
    <script src="<?=bs()?>assets/libs/custom/swal.js"></script>
	<script src="<?=bs()?>assets/plugins/icheck/icheck.min.js"></script>
<script>
