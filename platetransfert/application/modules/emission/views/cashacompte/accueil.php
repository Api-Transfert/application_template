            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        ...
                        <h1 class="title">Emission Cash à compte</h1>
            ...
            <div class="col-lg-12">
                <section class="box has-border-left-3">
                    <header class="panel_header">
                        <h2 class="title pull-left">Informations Expéditeur</h2>
                    </header>
...
<!--                                                    <span class="desc">"Entrer un nom"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
...
<!--                                                    <span class="desc">"Entrer un prenom"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                                        <input type="text" class="form-control" name="formfield1"  value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pl">
...
<!--                                                    <span class="desc">"Entrer un adresse"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                                        <input type="text" class="form-control" name="formfield1"  value="">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <span class="desc">"Avec le préfixe international. Exemple: 22507070707"</span>
                                                    <div class="controls">
                                                        <i class=""></i>
                                                        <input type="text" class="form-control" name="formfield1"  value="">
                                                    </div>
...
<!--                                                    <span class="desc">"Entrer un numéros"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                                        <input type="text" class="form-control" name="formfield1"  value="">
                                                    </div>
...
<!--                                                    <span class="desc">"Entrer un mot de passe"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                                        <input type="text" class="form-control" name="formfield1"  value="">
                                                    </div>
...
<!--                                                    <span class="desc">"Confirmer le mot de passe"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                                        <input type="date" class="form-control" name="formfield1"  value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pl">
...
<!--                                                    <span class="desc">"Confirmer le mot de passe"</span>-->
                                                    <div class="controls">
                                                        <input name="sms" tabindex="5" type="radio" id="minimal-checkbox-1" class="icheck-minimal-green" checked>
                                                        <label class="icheck-label form-label" for="minimal-checkbox-1">Oui</label>
                                                        <input name="sms" tabindex="5" type="radio" id="minimal-checkbox-2" class="icheck-minimal-red">
                                                        <label class="icheck-label form-label" for="minimal-checkbox-1">Non</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    <label class="form-label">Bénéficiaires habituels:
                                                    </label>
                                                    <!--                                                    <span class="desc">"Confirmer le mot de passe"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                            ...
                                            <header class="panel_header" style="border: none">
                                                <h2 class="title pull-left">Informations Bénéficiaire
                                                </h2>
                                            </header>
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    <label class="form-label">Numéros de compte*:
                                                    </label>
                                                    <!--                                                    <span class="desc">"Confirmer le mot de passe"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="form-control" name="group" id="" required="">
                                                            ...
                                                            <option value="61">Senegal</option>
                                            ...
                                            <header class="panel_header" style="border: none">
                                                <h2 class="title pull-left">
                                                    Informations Montant (XOF)
                                                </h2>
                                            </header>
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    <label class="form-label">Montant en lettres:
                                                    </label>
                                                    <!--                                                    <span class="desc">"Confirmer le mot de passe"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                            ...
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    <label class="form-label">Montant en chiffres*:
                                                    </label>
                                                    <!--                                                    <span class="desc">"Confirmer le mot de passe"</span>-->
                                                    <div class="controls">
                                                        <i class=""></i>
                                            ...
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    <label class="form-label">
                                                        Frais d'envoi HT: <strong>0</strong>
                                                    </label>
                                                    <!--                                                    <span class="desc">"Confirmer le mot de passe"</span>-->
                                                </div>
                                            </div>
                                            ...
                                            <div class="" style="clear: both">
                                                <button type="submit" class="btn btn-success btn-corner right15">
                                                    <i class="fa fa-check"></i> Valider</button>
                                                <button type="button" class="btn btn-danger btn-corner"><i class="fa fa-times"> Annuler</i></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
