        ...
        <div class="col-lg-12">
            <section class="box" style="padding: 10px 20px">
                ...
                >
                    <thead>
                    <tr>
                        <th data-field="Structure" data-sortable="true" data-switchable="true">Structure</th>
                        <th data-field="type" data-sortable="true" data-switchable="true">Type</th>
                        <th data-field="typeaction" data-sortable="true" data-switchable="true">Action</th>
                        <th data-field="taux" data-sortable="true">Taux</th>
                        <th data-field="base_taux" data-sortable="true">Base taux</th>
						<th data-field="taux_tutelle" data-sortable="true">TT</th>
						<th data-field="base_tutelle" data-sortable="true">BT</th>
						<th data-field="taux_commerciale" data-sortable="true">TC</th>
						<th data-field="base_commerciale" data-sortable="true">BC</th>
						<th data-field="taux_special" data-sortable="true">TS</th>
						<th data-field="taux_distributeur" data-sortable="true">TD</th>
						<th data-field="base_distributeur" data-sortable="true">BD</th>
						<th data-field="base_taux_special" data-sortable="true">BTS</th>
						<th data-field="base_structure_mere" data-sortable="true">BSM</th>
                    ...
                    <tbody>
                    <?php foreach($commission_data as $commi):?>
                        <tr>
							<td><?=$commi->structureName?>
						</td>
                            <td><?=$commi->productName?></td>
							<td>
						
							<?php if($commi->commissionActionType == '1'):; $ActionType='Emission'?>
                                    <button id="struc_st_<?=$commi->commissionId;?>" class="btn btn-success">Emission</button>
                                <?php else : $ActionType = 'Paiement';?>
                                    <button id="struc_st_<?=$commi->commissionId;?>" class="btn btn-primary">Paiement</button>
                                <?php endif;?>
						
						</td>
							<td><?=$commi->commissionTaux?></td>
							<td><?=$commi->commissionBaseTaux?></td>
                            <td><?=$commi->commissionTauxTutelle?></td>
                            <td><?=$commi->commissionBaseTutelle?></td>
                            <td><?=$commi->commissionTauxCommercial?></td>
                            <td><?=$commi->commissionBaseCommercial?></td>
							<td><?=$commi->commissionTauxSpecial?></td>
							<td><?=$commi->commissionTauxDistributeur?></td>
							<td><?=$commi->commissionBaseDistributeur?></td>
							<td><?=$commi->commissionBaseSpecial?></td>
							<td><?=$commi->commissionBaseQuickCash?></td> 
							<td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a class="strc_view" data-id="<?=$commi->commissionId?>" href="##"><i class="fa fa-eye"></i> Voir</a></li>
                                        <li><a class="strc_edit" data-id="<?=$commi->commissionId?>" href="##"><i class="fa fa-edit"></i> Modifier</a></li>
                                        <li><a class="strc_delete" data-id="<?=$commi->commissionId?>" href="##"><i class="fa fa-trash"></i> Supprimer</a></li>
                                        <li class="divider"></li>
