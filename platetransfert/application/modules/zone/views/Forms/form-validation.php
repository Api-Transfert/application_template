...
<script type="text/javascript" src="<?=bs('public/assets/plugins/form-parsley/parsley.js') ?>"></script>  					
<!-- Validate Plugin / Parsley -->
<script type="text/javascript" src="<?=bs('public/assets/demo/demo-formvalidation.js') ?>"></script>
